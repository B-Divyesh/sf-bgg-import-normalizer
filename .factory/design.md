...
The social preview (`public/assets/shelf-bridge-social.jpg`, 1200×630) is a reviewed, cropped derivative of that same original notebook still-life. The 180px Apple touch icon is a raster derivative of the hand-authored bridge SVG. Both are built locally by `npm run assets`; no third-party imagery or CDN asset is introduced.
